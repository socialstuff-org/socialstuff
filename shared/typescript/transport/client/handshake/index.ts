...
export class Handshake {
  ...
  public _handshakeResult = new Subject<void>();

  private _state: HandshakeState = new Initial();

  constructor(public username: string, public socket: Socket, public ecdh: ECDH, public rsa: { priv: KeyObject, pub: KeyObject }, public serverRsaPublicKey: KeyObject) {
